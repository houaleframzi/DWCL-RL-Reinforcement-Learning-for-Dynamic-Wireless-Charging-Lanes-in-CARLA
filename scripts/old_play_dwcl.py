...
from src.carla_simulator.old_carla_env import CarlaEnv
...
class DWCLPygameVisualizer:
    ...
    def initialize_simulation(self, power_model_path: str):
        ...
        try:
            ...
            vehicle_manager = VehicleManager(self.world)
            self.vehicle = vehicle_manager.spawn_vehicle(location=(20, 250, 0.0))
            
            # Create DWCL
            print("Creating DWCL...")
            sim_config = settings.SimulationSettings()
            self.dwcl_manager = DWCLManager(self.world, sim_config)
            ...
            print("Initializing battery manager...")
            ...
            self.traffic_manager = TrafficManager(self.client, self.vehicle)
    ...
    def run(self):
        ...
        if not self.initialize_simulation("models/energy_model_best.hdf5"):
...
def main():
    ...
    power_model_path = "c:\\Users\\HOUALEF\\Downloads\\New_CARLA\\models\\energy_model_best.hdf5"
